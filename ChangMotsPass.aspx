        ...
        <script type="text/javascript">
            ...
            function ValidationChangePassCallback(s, e) {
                ...
                if (errPoin == "Changer") {
                    ...
                    txterror.SetText('Changer avec succès');
            ...
            function ValidationminConfPassw(s, e) {

                if (PasswordTextbox.GetText() == PasswordConfirmTextbox.GetText()) {
                    ...
                    e.isValid = false;
                    e.errorText = "Verifier votre saisie ";
                }
            }
            ...
            function CallbackDateOLD_Callback(s, e) {
                var str = e.result;


                alert(str);
                //if (passbase != oldpassw) {
                //    txtOldPassword.SetIsValid(false);
                //}
                ...
                <table width="100%" align="center">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <dx:ASPxTextBox ID="txtOldPassword" ClientInstanceName="txtOldPassword" runat="server" NullText="Ancien mot de passe" Password="true"
                                Height="40px" Width="400px">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <dx:ASPxTextBox ID="PasswordTextbox" ClientInstanceName="PasswordTextbox" Password="true" runat="server" NullText="Nouveau mot de passe"
                                Height="40px" Width="400px">
                                ...
                                <ValidationSettings ErrorTextPosition="Bottom" ErrorDisplayMode="Text" Display="Static" SetFocusOnError="true" ValidationGroup="softic">
                                    ...
                                    <RegularExpression ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&](?:([\w\d+-_*?!:;])\2?(?!\1)){8,}" ErrorText="Le mot de passe ne répond pas aux critères minimaux !!" />
                                </ValidationSettings>
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="center" style="font-size: 12px; color: darkgray">
                            <div>
                                Le nouveau mot de passe doit contenir : au moins 8 caractères,<br />
                                majuscules, minuscules, chiffres,
                            <br />
                                caractères spéciaux (%, #, etc.), aucun caractère consécutif.
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <dx:ASPxTextBox ID="PasswordConfirmTextbox" ClientInstanceName="PasswordConfirmTextbox" Password="true" runat="server" NullText="Confirmez le mot de passe"
                                Height="40px" Width="400px">
                                <ClientSideEvents Validation="ValidationminConfPassw" />
                                <ValidationSettings ErrorTextPosition="Bottom" ErrorDisplayMode="Text" Display="Static" SetFocusOnError="true" ValidationGroup="softic">
                                    <RequiredField IsRequired="True" ErrorText="The value is required" />
                                    <RegularExpression ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&](?:([\w\d+-_*?!:;])\2?(?!\1)){8,}" ErrorText="Le mot de passe ne répond pas aux critères minimaux !!" />
                                </ValidationSettings>
                    ...
                    <tr>
                        <td align="center" colspan="2">
                            <dx:ASPxButton ID="btnOK" ClientInstanceName="btnOK" Text="Changer le mot de passe" Font-Bold="True" BackColor="#187cc2" runat="server" Theme="Metropolis"
