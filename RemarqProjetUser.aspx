<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RemarqProjetUser.aspx.cs" Inherits="RemarqProjetUser" %>
                            ...
                            <dx:LayoutItem Caption="Type" ShowCaption="False" ColumnSpan="2" ColSpan="2" >
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                            ...
                                            <dx:ASPxMemo ID="MemoRemarqProjet" runat="server"  Height="270px" Width="100%"></dx:ASPxMemo>
